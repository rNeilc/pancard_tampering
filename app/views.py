...
app.config['INITIAL_FILE_UPLOADS'] = 'app/staic/uploads'
...
def index():
    ...
    if request.method == "POST":
        ...
        thresh = cv2.threshold(diff, 0, 255, cv2.THRESHOLD_BINARY_INV | cv2.THRESH_OTSU)[1]
        cnts = cv2.findContours(thresh.copy(), cv2.RERT_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
        ...
        return render_template('index.html', pred=str(score*100,2)) + '%' + ' correct'
